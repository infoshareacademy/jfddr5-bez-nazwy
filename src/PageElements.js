...
const PageElements = () => {
         ...
         return (
            <div className={s.divStyle}> 
                ...
                <div><img src={pets1} alt="four dogs looking at cookie in hand" className={s.imgStyle}/></div>
                
                <div>
                <h2 className={s.textBox2}>Specjaliści w Twojej okolicy</h2>
                    <p>
                ...
                <div><img src={pets2} alt="cat touching hand with woman" className={s.imgStyle}/></div>
            </div>
         )
